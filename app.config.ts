...
const config: ExpoConfig = {
  name: 'Muenot Shopkeeper', slug: 'muenot-shopkeeper', version: packageJson.version,
  scheme: 'muenot', orientation: 'portrait', userInterfaceStyle: 'light',
  icon: './assets/images/logo-mark.png',
  android: {
    package: 'com.muenot.shopkeeper', versionCode: 1, softwareKeyboardLayoutMode: 'resize',
  ...
  plugins: ['./plugins/withMuenotReleaseSigning', 'expo-router', 'expo-status-bar', 'expo-secure-store', 'expo-web-browser', ['expo-notifications', {
